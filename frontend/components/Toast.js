...
export function ToastProvider({ children }) {
  ...
  return (
    <ToastContext.Provider value={{ addToast }}>
      {children}
      <div className="fixed top-20 right-4 z-[9998] space-y-2">
        {toasts.map(toast => (
...
function ToastItem({ type, message, onClose }) {
  ...
  return (
    <div className={`${style.bg} text-white px-6 py-4 rounded-xl shadow-2xl flex items-center min-w-[300px] animate-slideInRight`}>
